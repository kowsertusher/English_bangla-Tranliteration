import sys
sys.path.insert(0, '/home/remote_user/spell/Context-sensitive-Bangla-spell-checker/Others/checker')
import re, os
...
#	sample = 1e-3   # Downsample setting for frequent words
	...
	model = word2vec.Word2Vec(sentences, workers=workers,size=size, min_count=min_count,window=window, sg=sg, hs = hs, negative=negative)
